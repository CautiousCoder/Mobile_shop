    ...
    <div class="orders">
        <div class="card">
            <div class="card-body d-flex justify-content-between">
                ...
                <a href="../pages/category_create.php" class="btn btn-lg bg-primary btn-outline-dark">Create</a>
            </div>
            <div class="card-body--">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-end">
                                            <a href="../pages/category_create.php<?php echo '?type=edit&id='.$row['id']; ?>"><?php btnElement("edit", "btn btn-warning mr-2", "edit", "<i class='fa-solid fa-pen-to-square font-size-20 text-white'></i>", "data-bs-toggle='tooltip' data-bs-placement='bottom' title='Edit'") ?></a>
